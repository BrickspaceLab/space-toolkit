export const collections = {
  ...
  async fetchAndRenderPage(direction: "next" | "previous") {
    ...
    if (
      this.pagination_current_page < this.pagination_total_pages ||
      direction === "previous"
    ) {
      // Get data from Shopify
      try {
